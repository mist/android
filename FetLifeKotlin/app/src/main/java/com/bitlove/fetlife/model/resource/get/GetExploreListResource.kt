...
class GetExploreListResource(val type: ExploreStory.TYPE, val forceLoad: Boolean, val limit: Int, userId : String? = getLoggedInUser()?.getLocalId()) : GetListResource<ExploreStory>(userId, limit) {
