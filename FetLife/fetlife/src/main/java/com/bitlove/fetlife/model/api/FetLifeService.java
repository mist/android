...
public class FetLifeService {
    ...
    public static final String WEBVIEW_BASE_URL = "https://staging.fetlife.com";
    public static final String BASE_URL = "https://staging.fetlife.com";
    public static final String HOST_NAME = "staging.fetlife.com";
